...
class StreamPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username="example", password="Pass@1234")
...
class WatchListTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.stream = models.StreamPlatform.objects.create(name="Netflix", about="#1 Platform", 
                                                           website = "https://www.netflix.com")
        self.watchlist = models.WatchList.objects.create(platform=self.stream, title="Example Title",
...
class ReviewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.watchlist = models.WatchList.objects.create(platform=self.stream, title="Example Title",
                                                         storyline="Example Movie", active = True)
        self.watchlist2 = models.WatchList.objects.create(platform=self.stream, title="Example Title",
                                                         storyline="Example Movie", active = True)
